...
namespace AlbanianXrm.SolutionPackager
{
    [Export(typeof(IXrmToolBoxPlugin)),
       ExportMetadata("Name", "Albanian Solution Packager"),
       ExportMetadata("Company", "Betim Beja"),
       ExportMetadata("Description", "This plugin simplifies the use of SolutionPackager which is distributed as part of the Microsoft.CrmSdk.CoreTools NuGet package"),
